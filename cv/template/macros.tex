...
%%%%%%%%%%%%%%% Email %%%%%%%%%%%%%%%
\newcommand{\emaildisplay}[1]{
    \par\info{\href{mailto:#1}{\underline{#1}}}{envelope}%
    \vspace{0.5em}%
}

%%%%%%%%%%%%%%% Phone Number %%%%%%%%%%%%%%%
\newcommand{\phonedisplay}[1]{
...
%%%%%%%%%%%%%%% GitHub %%%%%%%%%%%%%%%
\newcommand{\githubdisplay}[2]{
    \par\info{\href{#1}{\underline{#2}}}{github}%
    \vspace{0.5em}%
}

%%%%%%%%%%%%%%% LinkedIn %%%%%%%%%%%%%%%
\newcommand{\linkedindisplay}[2]{
    \par\info{\href{#1}{\underline{#2}}}{linkedin}%
    \vspace{0.5em}%
}

%%%%%%%%%%%%%%% StackOverflow %%%%%%%%%%%%%%%
\newcommand{\stackoverflowdisplay}[2]{
...
\newcommand{\projectdisplay}[5]{ % input: years, project, description, stack, worklinks
  \hyphenpenalty=100000%
  \vspace*{0.5em}%
  \par\adjustbox{valign=m}{\begin{minipage}{2.5cm}%
        \begin{center}%
            {\small \bfseries #1} \\
            \vspace*{0.3em}%
        \end{center}%
    \end{minipage}}%
    \hfill \vline \hfill%
    \adjustbox{valign=m}{\begin{minipage}{8cm}%
        \par\uppercase{\textbf{\large #2}}%
        \ifstrempty{#3}{}{%
          \vspace*{0.15em}%
          \par\uppercase{\small #3}%
        }%
        \ifstrempty{#4}{}{%
          \vspace*{0.25em}%
          \par\emph{\small #4}%
...
% Command for Experience
\newcommand{\workdisplay}[7]{ % input: years, logo, company, title, stack, description
  \hyphenpenalty=100000%
  \vspace*{0.5em}%
  \par\adjustbox{valign=m}{\begin{minipage}{2.5cm}%
        \begin{center}%
...
\newcommand{\educationdisplay}[7]{ % input: years, logo, title, university, city, specialization, description
  \hyphenpenalty=100000
  \vspace*{0.4em}
  \par\adjustbox{valign=m}{\begin{minipage}{2.5cm}
        \begin{center}
